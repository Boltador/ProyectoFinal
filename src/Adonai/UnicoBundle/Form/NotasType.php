...
class NotasType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('periodo',EntityType::class,array(
            ...
            'required' => true,
            'label' => 'Periodo: '));
        //$competenciaSubscriber = new AddCompetenciaFieldSubscriber($factory);
        //$builder->addEventSubscriber($competenciaSubscriber);*/
        //$builder->add('nota',TextType::class,array('label' => 'Nota: '));
    }
