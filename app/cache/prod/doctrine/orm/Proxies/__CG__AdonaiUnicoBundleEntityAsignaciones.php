 ...
 */
class Asignaciones extends \Adonai\UnicoBundle\Entity\Asignaciones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Asignaciones' . "\0" . 'idAsignacion', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Asignaciones' . "\0" . 'asignatura', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Asignaciones' . "\0" . 'docente', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Asignaciones' . "\0" . 'grupo', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Asignaciones' . "\0" . 'a_lectivo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Asignaciones $proxy) {
    ...
    public function getIdAsignacion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdAsignacion();
        }
    ...
    public function getListaAsignacionesActual($docente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getListaAsignacionesActual', array($docente));

        return parent::getListaAsignacionesActual($docente);
    }
