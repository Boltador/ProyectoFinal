 ...
 */
class Roles extends \Adonai\UnicoBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Roles' . "\0" . 'id', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Roles' . "\0" . 'nombre', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Roles' . "\0" . 'role', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Roles' . "\0" . 'users');
        }
