 ...
 */
class Planeadores extends \Adonai\UnicoBundle\Entity\Planeadores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Planeadores' . "\0" . 'idPlan', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Planeadores' . "\0" . 'asignacion', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Planeadores' . "\0" . 'periodo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Planeadores $proxy) {
    ...
    public function getIdPlan()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdPlan();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdPlan', array());
