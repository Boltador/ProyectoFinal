...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'adonai.asignaciones.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Adonai\UnicoBundle\Doctrine\AsignacionesManager A Adonai\UnicoBundle\Doctrine\AsignacionesManager instance.
     */
    protected function getAdonai_Asignaciones_ManagerService()
    {
        $this->services['adonai.asignaciones.manager'] = $instance = new \Adonai\UnicoBundle\Doctrine\AsignacionesManager($this->get('doctrine.orm.default_entity_manager'), $this->get('debug.event_dispatcher'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'proyectodb', 'user' => 'root', 'password' => 'nadadenada', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6e0a0186decf4e4010a70b689b9ec975db7afdb851700c1e7257fbdd45a3de82');
