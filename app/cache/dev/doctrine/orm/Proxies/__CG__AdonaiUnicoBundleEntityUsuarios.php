 ...
 */
class Usuarios extends \Adonai\UnicoBundle\Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'id', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'username', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'salt', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'password', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'isActive', '' . "\0" . 'Adonai\\UnicoBundle\\Entity\\Usuarios' . "\0" . 'roles');
        }
